...
DRIVER_IMAGE = 'australia-southeast1-docker.pkg.dev/analysis-runner/images/driver:646dcc2ab7e484314943b979d2132b0133dbbe94-hail-b28ed8c6a7f8dadc9275a87064b5ccfe562238c3'
...
batch = hb.Batch('requester-pays-tests', backend=sb, requester_pays_project=HAIL_PROJECT)
...
if JOBS_COPY_OUT in jobs:
    ...
    batch.write_output(copy_out_file, os.path.join(requester_pays_base, 'copy-output.txt'))
